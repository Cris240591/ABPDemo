...
{
    public abstract class ABMExampleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABMExampleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABMExampleWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<ABMExampleDbContext> action)
        {
            using (var context = IocManager.Resolve<ABMExampleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<ABMExampleDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<ABMExampleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABMExampleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABMExampleDbContext, Task<T>> func)
        {
            T result;
